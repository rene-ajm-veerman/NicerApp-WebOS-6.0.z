<?php 
    ...
    $na_apps_structure = [
        "diary__guseu__index" => [
            'apps-current' => [
                'NicerApp-WebOS__pageSettings' => [
                    ...
                    "apps" => [
                        'diskText' => [
                            'file' => '/siteDiaries/Griffin-US-EU/files/index.php',
                            'title' => '/siteDiaries/Griffin-US-EU/files/index.title.php',
                            'seoValue' =>  [ 'guseu' ]
                        ]
                     ]
                ]
        ...
        "diary__psychiatric_evolution__index" => [
            'apps-current' => [
                'NicerApp-WebOS__pageSettings' => [
                    'misc' => [
                        'folder' => '/NicerAppWebOS/apps/NicerAppWebOS/content-management-systems/NicerAppWebOS'
                    ...
                    "apps" => [
                        'diskText' => [
                            'file' => '/siteDiaries/psychiatric-evolution/files/index.php',
                            'title' => '/siteDiaries/psychiatric-evolution/files/index.title.php',
                            'seoValue' =>  [ 'psychiatric-evolution' ]
                        ]
                    ]
                ]
            ]
        ...
        "diary__Refirenda__index" => [
            'apps-current' => [
                'NicerApp-WebOS__pageSettings' => [
                    ...
                    "apps" => [
                        'diskText' => [
                            'file' => '/siteDiaries/Refirenda/files/index.php',
                            'title' => '/siteDiaries/Refirenda/files/index.title.php',
                            'seoValue' =>  [ 'Refirenda' ]
                        ]
                    ]
                ]
        ...
        "diary__Rene-AJM-Veerman__index" => [
            'apps-current' => [
                'NicerApp-WebOS__pageSettings' => [
                    'misc' => [
                        'folder' => '/NicerAppWebOS/apps/NicerAppWebOS/content-management-systems/NicerAppWebOS'
                    ...
                    "apps" => [
                        'diskText' => [
                            'file' => '/siteDiaries/Rene-AJM-Veerman/files/index.php',
                            'title' => '/siteDiaries/Rene-AJM-Veerman/files/index.title.php',
                            'seoValue' =>  [ 'Rene-AJM-Veerman' ]
                        ]
                    ]
                ]
            ]
