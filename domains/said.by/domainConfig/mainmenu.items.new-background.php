<li id="subMenu__new-background" class="subMenu"><a class="noPushState" href="javascript:na.backgrounds.next('#siteBackground');">Background</a>
    <ul>
        ...
        <li><a class="noPushState" href="javascript:na.backgrounds.next('#siteBackground','iframe');">CGI</a>
            <ul>
                <li><a class="noPushState" href="javascript:na.backgrounds.next('#siteBackground', 'iframe 2D', '2D');">2D CGI</a></li>
                <li><a class="noPushState" href="javascript:na.backgrounds.next('#siteBackground', 'iframe 3D', '3D');">3D CGI</a></li>
            </ul>
        </li>
