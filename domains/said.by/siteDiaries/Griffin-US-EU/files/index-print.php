<?php
    ...
    require_once ($naWebOS->codePath.'/NicerAppWebOS/businessLogic/vividUserInterface/v5.y.z/photoAlbum/4.0.0/functions.php');
...
<script src="https://code.jquery.com/jquery-3.7.1.js" integrity="sha256-eKhayi8LEQwp4NKxN+CfCh+3qOVUtJn3QNZ0TciWLP4=" crossorigin="anonymous"></script>
    ...
    <link type="text/css" rel="StyleSheet" href="/NicerAppWebOS/documentation/NicerEnterprises--company--moods-screen.css?c=NOW">
        ...
        <h3>Introduction</h3>
        <p class="backdropped" style="margin-left:50px;">Europe and the US stand before their biggest Cold War yet; multiple potential regional wars, and threat of nuclear war with more and more countries desiring and reaching Mutually Assured Destruction status.<br/>
        https://said.by/guseu<br/>
        </p>
        ...
        <?php
            ...
            krsort ($fi);
            foreach ($fi as $m => $fp) {
                echo '<span class="backdropped">'.$fp['webPath'].'  : '.date('Y-m-d H:i:s', $m).'</span>';
            }
        ?>
        </div>
        <h3>The Griffin</h3>
