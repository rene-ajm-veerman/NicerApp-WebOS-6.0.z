...
$view = $naWebOS->view;
if (!array_key_exists('rp',$view)) $view['rp'] = '/';
...
?>
	...
	?>
		<h1 id="pageTitle" class="naVividTextCSS" style="font-size:200%;">Error:UNKNOWN-Folder on said.by/music</h1>
	<?php
		}
	?>
        ...
        <?php
            ...
            foreach ($views as $k1 => $v1) {
                foreach ($v1 as $k2 => $v2) {
                    foreach ($v2 as $k3 => $v3) {
                        if (array_key_exists('rp',$view) && $view['rp'] == $v3['rp']) {
